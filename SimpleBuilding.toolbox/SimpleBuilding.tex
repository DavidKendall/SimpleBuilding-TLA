...
\@x{}\moduleLeftDash\@xx{ {\MODULE} SimpleBuilding}\moduleRightDash\@xx{}%
\begin{lcom}{5.0}%
...
\@pvspace{8.0pt}%
\@x{ TypeOk \.{\defeq}}%
\@x{\@s{8.2} \.{\land} register \.{\subseteq} PERSON\@s{78.09}}%
\@y{\@s{0}%
 Everyone on the register is a person
}%
\@xx{}%
\@x{\@s{8.2} \.{\land} register \.{=} in \.{\cup} out\@s{85.99}}%
\@y{\@s{0}%
 The location of every registered person is known
}%
\@xx{}%
\@x{\@s{8.2} \.{\land} in \.{\cap} out \.{=} \{ \}\@s{108.76}}%
\@y{\@s{0}%
...
\@x{}\midbar\@xx{}%
\@x{ Init \.{\defeq}}%
\@x{\@s{8.2} \.{\land} register \.{=} \{ \}\@s{111.31}}%
\@y{\@s{0}%
 Initially, nobody is registered
}%
\@xx{}%
\@x{\@s{8.2} \.{\land} in \.{=} \{ \}}%
\@x{\@s{8.2} \.{\land} out \.{=} \{ \}}%
\@pvspace{8.0pt}%
\@x{ Register ( p ) \.{\defeq}}%
 \@x{\@s{8.2} \.{\land} p \.{\in} PERSON \.{\,\backslash\,}
 register\@s{64.01}}%
\@y{\@s{0}%
 Can only register an unregistered person
}%
\@xx{}%
 \@x{\@s{8.2} \.{\land} register \.{'} \.{=} register \.{\cup} \{ p
 \}\@s{58.88}}%
\@y{\@s{0}%
 The person is added to the register
}%
\@xx{}%
\@x{\@s{8.2} \.{\land} out \.{'} \.{=} out \.{\cup} \{ p \}\@s{94.92}}%
\@y{\@s{0}%
 When first registered, the person is outside the building
}%
\@xx{}%
\@x{\@s{8.2} \.{\land} in \.{'} \.{=} in\@s{132.36}}%
\@y{\@s{0}%
 Registering a person does not change who is inside the building
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ Enter ( p ) \.{\defeq}}%
\@x{\@s{8.2} \.{\land}\@s{6.30} p \.{\in} out\@s{127.27}}%
\@y{\@s{0}%
 Only registered persons outside the building can enter
}%
\@xx{}%
\@x{\@s{8.2} \.{\land}\@s{6.30} in \.{'} \.{=} in \.{\cup} \{ p \}\@s{99.19}}%
\@y{\@s{0}%
 The person is added to the set of persons inside the building
}%
\@xx{}%
 \@x{\@s{8.2} \.{\land}\@s{6.30} out \.{'} \.{=} out \.{\,\backslash\,} \{ p
 \}\@s{91.38}}%
\@y{\@s{0}%
 The person is removed from the set of persons outside the building
}%
\@xx{}%
\@x{\@s{8.2} \.{\land}\@s{6.30} register \.{'} \.{=} register\@s{79.43}}%
\@y{\@s{0}%
...
\@pvspace{8.0pt}%
\@x{ Leave ( p ) \.{\defeq}}%
\@x{\@s{8.2} \.{\land}\@s{5.60} p \.{\in} in\@s{133.27}}%
\@y{\@s{0}%
 Only registered persons inside the building can leave
}%
\@xx{}%
 \@x{\@s{8.2} \.{\land}\@s{5.60} out \.{'} \.{=} out \.{\cup} \{ p
 \}\@s{89.32}}%
\@y{\@s{0}%
 The person is added to the set of persons outside the building
}%
\@xx{}%
 \@x{\@s{8.2} \.{\land}\@s{5.60} in \.{'} \.{=} in \.{\,\backslash\,} \{ p
 \}\@s{102.68}}%
\@y{\@s{0}%
 The person is removed from the set of persons inside the building
}%
\@xx{}%
\@x{\@s{8.2} \.{\land}\@s{5.60} register \.{'} \.{=} register\@s{80.14}}%
\@y{\@s{0}%
 The register is unchanged
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq}\@s{146.89}}%
\@y{\@s{0}%
 A \ensuremath{Next} step is \.{\dots}
}%
\@xx{}%
\@x{\@s{8.2} \E\, p \.{\in} PERSON \.{:}\@s{100.66}}%
\@y{\@s{0}%
 for some person \.{\dots}
}%
\@xx{}%
\@x{\@s{16.4} \.{\lor} Register ( p )\@s{109.84}}%
\@y{\@s{0}%
 either the person is registered
}%
\@xx{}%
\@x{\@s{16.4} \.{\lor} Enter ( p )\@s{120.07}}%
\@y{\@s{0}%
 or the person enters the building
}%
\@xx{}%
\@x{\@s{16.4} \.{\lor} Leave ( p )\@s{120.77}}%
\@y{\@s{0}%
 or the person leaves the building
}%
\@xx{}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sun \ensuremath{Sep} 23
 10:56:47 \ensuremath{BST} 2018 by \ensuremath{cgdk2
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Wed} \ensuremath{Sep} 12
 12:44:40 \ensuremath{BST} 2018 by \ensuremath{cgdk2
}%
\end{cpar}%
\end{lcom}%
\end{document}
